...
public class LoggingSettingsService(AppSettingsService appSettings)
{
    ...
    public static LogEventLevel[] GetAvailableLogLevels() =>
    [
    ...
    public static string GetLogLevelDisplayName(LogEventLevel level) => level switch
    {
